	...
	<li><a href="<?php echo U('Center/group');?>" <?php if(ACTION_NAME == 'group'): ?>class="da_left_def"<?php endif; ?>>我的小组</a></li>
			...
			<div class="da_right">
				<div class="member-nav">
					<a href="<?php echo U('Portal/Center/myanswer',array('tab'=>'case'));?>" <?php if($_GET['tab']== 'case'): ?>class="nav-hover"<?php endif; ?>>案例</a>
					<a href="<?php echo U('Portal/Center/myanswer',array('tab'=>'technology'));?>" <?php if($_GET['tab']== 'technology'): ?>class="nav-hover"<?php endif; ?>>技术</a>
					<a href="<?php echo U('Portal/Center/myanswer',array('tab'=>'debate'));?>" <?php if($_GET['tab']== 'debate'): ?>class="nav-hover"<?php endif; ?>>辩论</a>
				</div>
				<div class="member-list">
					<ul class="db clearfix">
						<?php if(is_array($myanswer)): $i = 0; $__LIST__ = $myanswer;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="myanswer1 pd">
								<a href="<?php echo ($vo["url"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a>
							</li>
							<li class="myanswer2"><?php echo ($vo["message"]); ?></li>
							<li class="myanswer3"><?php echo ($vo["time"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
