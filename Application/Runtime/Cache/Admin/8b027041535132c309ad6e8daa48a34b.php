...
<html>
	<head>
		...
		<link href="/static/admin/css/login.css<?php echo ($js_debug); ?>" rel="stylesheet" />
	...
	<body>
		<div class="wrap">
			<h1><a href="">ThinkCMF Extend 后台管理中心</a></h1>
					...
					<ul>
						...
						<li>
							<div id="J_verify_code">
								<?php echo show_verify_img('length=4&height=50&width=238&size=20');?>
							</div>
						</li>
						<li>
		...
		<script type="text/javascript" src="/static/js/common.js<?php echo ($js_debug); ?>"></script>
		<script>
			;
			(function() {
